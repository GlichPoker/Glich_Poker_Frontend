...
export default function WeatherIcon({ weatherType }: WeatherIconProps) {
    ...
    const descriptionMap: Record<WeatherType, string> = {
        SUNNY: "A desert mirage plays tricks on the mind. Once every round, you may bluff with a fake or real card. The big blind also increases by 5% every third round.",
        ...
        DEFAULT: "Weather-based rules are not applied"
    };
